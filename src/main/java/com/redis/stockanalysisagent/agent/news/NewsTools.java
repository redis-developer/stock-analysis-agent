...
import com.redis.stockanalysisagent.providers.NewsProvider;
import com.redis.stockanalysisagent.providers.NewsSearchProvider;
...
public class NewsTools {
    ...
    private final NewsSearchProvider newsSearchProvider;

    public NewsTools(NewsProvider officialNewsProvider, NewsSearchProvider newsSearchProvider) {
    ...
    public NewsSnapshot fetchNewsSnapshot(String ticker, String question) {
        ...
        NewsSearchProvider.SearchResult webResult = newsSearchProvider.search(
                ticker,
