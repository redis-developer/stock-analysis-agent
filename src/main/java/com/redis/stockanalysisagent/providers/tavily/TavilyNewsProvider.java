...
@Component
public class TavilyNewsProvider implements NewsSearchProvider {
    ...
    @Override
    public SearchResult search(String ticker, String companyName, String question) {
        ...
        Object cachedPayload = externalDataCache.getOrLoad(
                ...
                () -> {
                    ...
                    return new SearchResult(items, optionalText(response, "answer", null));
                }
        );
